// 1. [X] 페이지별 enter / leave 애니메이션 구성
// 2. [X] title enter / leave 애니메이션
// 3. [X] section 정렬하기
// 4. [X] event 연결하기
// 5. [X] next와 current구분 후 애니메이션 재생
// 6. [X] playing 상태 변수 제어
// 7. [X] 시즌별 text 변경
...
window.addEventListener("load", () => {
  const tl = gsap.timeline().add(enter1.play()).add(titleEnter.play());
